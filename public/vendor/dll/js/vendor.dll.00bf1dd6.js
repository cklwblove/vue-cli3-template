var vendor_library = (function(t) {
    ...
    n.r(e),
      function(t) {
        ...
        var Un = [],
          ...
          zn = 0;
        function Wn() {
          (zn = Un.length = Hn.length = 0), (Vn = {}), (Bn = qn = !1);
        }
        var Kn = 0,
          Xn = Date.now;
        if (J && !tt) {
        ...
        function Jn() {
          ...
          var n = Hn.slice(),
            r = Un.slice();
          Wn(), Zn(n), Qn(r), ut && V.devtools && ut.emit('flush');
        }
        function Qn(t) {
          var e = t.length;
          while (e--) {
            ...
            if (!O || w || '' === w) {
              ...
              var D = !1 !== a && !et,
                ...
                F = (n._enterCb = N(function() {
                  D && (Di(n, j), Di(n, E)),
                    F.cancelled ? (D && Di(n, S), P && P(n)) : R && R(n),
                    (n._enterCb = null);
                }));
              t.data.show ||
  ...
  function(t, e, n) {
        ...
        render: function(t) {
          ...
          if ('a' === this.tag) (b.on = _), (b.attrs = { href: c });
            ...
            if (w) {
              ...
              C.on = _;
              var $ = (w.data.attrs = i({}, w.data.attrs));
              $.href = c;
            } else b.on = _;
          }
    ...
    function Tt(t, e) {
      ...
      try {
        e
          ? n.replaceState({ key: Ot }, '', t)
          : ((Ot = St()), n.pushState({ key: Ot }, '', t));
      } catch (r) {
      ...
      return (
        ...
        (e.prototype.replace = function(t, e, n) {
          ...
          this.transitionTo(
            t,
            function(t) {
              It(D(r.base + t.fullPath)), yt(r.router, t, i, !1), e && e(t);
            },
            n
          );
        }),
      ...
      return (
        ...
        (e.prototype.setupListeners = function() {
          var t = this,
            ...
            r = $t && n;
          r && vt(),
            window.addEventListener($t ? 'popstate' : 'hashchange', function() {
              var e = t.current;
              ee() &&
    ...
    function ie(t) {
      $t ? It(re(t)) : window.location.replace(re(t));
    }
    var ae = (function(t) {
        function e(e, n) {
