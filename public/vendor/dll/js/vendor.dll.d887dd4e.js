      ...
      function(t) {
        ...
        var jt = function(t) {
          (this.value = t),
            ...
            z(t, '__ob__', this),
            Array.isArray(t)
              ? (G ? Tt(t, $t) : It(t, $t, Ot), this.observeArray(t))
              : this.walk(t);
        };
        function Tt(t, e) {
          t.__proto__ = e;
        ...
        function Ye(t, e, r, i, a) {
          ...
          if (Array.isArray(p)) {
            for (
              var d = $e(p) || [], h = new Array(d.length), v = 0;
              v < d.length;
              v++
            )
        ...
        function Sn(t, e, n) {
          (yn = t), be(e, n || {}, $n, kn, On, t), (yn = void 0);
        }
        function En(t) {
          var e = /^hook:/;
        ...
        var Un = [],
          ...
          zn = 0;
        function Wn() {
          (zn = Un.length = Bn.length = 0), (Hn = {}), (Vn = qn = !1);
        }
        var Kn = 0,
          Xn = Date.now;
        if (J && !tt) {
        ...
        function Io(t) {
          ...
          function w(t, n) {
            ...
            (e = t.data.hook),
              o(e) &&
                (o(e.create) && e.create(Oo, t), o(e.insert) && n.push(t));
          }
          function x(t) {
            var e;
            ...
            if (!O || w || '' === w) {
              ...
              var D = !1 !== a && !et,
                ...
                F = (n._enterCb = N(function() {
                  D && (Di(n, j), Di(n, E)),
                    F.cancelled ? (D && Di(n, S), R && R(n)) : P && P(n),
                    (n._enterCb = null);
                }));
              t.data.show ||
                ...
                D &&
                  ...
                  Ri(function() {
                    Di(n, S),
                      F.cancelled ||
                        (Li(n, j),
                        M || (qi(L) ? setTimeout(F, L) : Mi(n, s, F)));
                  })),
          ...
          if (!o(n._leaveCb)) {
            ...
            var x = (n._leaveCb = N(function() {
              n.parentNode &&
                ...
                _ && (Di(n, f), Di(n, l)),
                x.cancelled ? (_ && Di(n, u), y && y(n)) : (e(), h && h(n)),
                (n._leaveCb = null);
            }));
            m ? m(C) : C();
          }
            ...
            x.cancelled ||
              ...
              _ &&
                ...
                Ri(function() {
                  Di(n, u),
                    x.cancelled ||
                      (Li(n, f), b || (qi(w) ? setTimeout(x, w) : Mi(n, s, x)));
                })),
              d && d(n, x),
              _ || b || x());
          }
        ...
        var Ki = J
            ...
            : {},
          Xi = [qo, Ko, ri, ci, bi, Ki],
          Gi = Xi.concat(Uo),
          Ji = Io({ nodeOps: Ao, modules: Gi });
        et &&
  ...
  function(t, e, n) {
    ...
    function J(t, e, n) {
      return (
        j(e) || ((n = e || n), (e = [])),
        (n = n || {}),
        t instanceof RegExp ? W(t, e) : j(t) ? K(t, e, n) : X(t, e, n)
      );
    }
    (T.parse = I),
      (T.compile = P),
    ...
    var tt,
      ...
      ot = {
        ...
        render: function(t) {
          ...
          (u[v] = C(r, y)), (u[h] = this.exact ? u[v] : $(r, y));
          var m = function(t) {
          ...
          if ('a' === this.tag) (b.on = _), (b.attrs = { href: c });
            ...
            if (x) {
              ...
              for (var k in ((A.on = A.on || {}), A.on)) {
                var O = A.on[k];
                k in _ && (A.on[k] = Array.isArray(O) ? O : [O]);
              }
              for (var S in _) S in A.on ? A.on[S].push(_[S]) : (A.on[S] = m);
    ...
    (qt.prototype.listen = function(t) {
      ...
      (qt.prototype.confirmTransition = function(t, e, n) {
        ...
        if (C(t, s) && t.matched.length === s.matched.length)
          return this.ensureURL(), c(new Vt(t));
            ...
            window.addEventListener(Pt ? 'popstate' : 'hashchange', function() {
              ...
              ie() &&
                t.transitionTo(ae(), function(n) {
                  r && Ct(t.router, n, e, !0), Pt || ue(n.fullPath);
                });
            });
        }),
        (e.prototype.push = function(t, e, n) {
    ...
    function ce(t) {
      Pt ? Rt(se(t)) : (window.location.hash = t);
    }
    function ue(t) {
      Pt ? Lt(se(t)) : window.location.replace(se(t));
    }
    var fe = (function(t) {
        function e(e, n) {
